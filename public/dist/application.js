 ...
 */
  function minErr(module) {
    return function () {
      ...
      message = message + '\nhttp://errors.angularjs.org/1.2.23/' + (module ? module + '/' : '') + code;
...
}(window, window.angular));  //# sourceMappingURL=angular-touch.min.js.map
...
FastClick.prototype.needsClick = function (a) {
  ...
  'use strict';
  return FastClick;
}) : 'undefined' != typeof module && module.exports ? (module.exports = FastClick.attach, module.exports.FastClick = FastClick) : window.FastClick = FastClick, angular.module('mobile-angular-ui.active-links', []).run([
  '$rootScope',
  function (a) {
    return angular.forEach([
      ...
      return a.$on(b, function () {
        var a;
        return a = window.location.href, angular.forEach(document.links, function (b) {
          var c;
          return c = angular.element(b), b.href === a ? c.addClass('active') : c.removeClass('active'), c = null;
        }), a = null;
      });
    });
  }
  ...
  function (a) {
    ...
    return {
      ...
      resetYielder: function (a) {
        var c = b[a];
        this.setContentFor(a, c.defaultContent, c.defaultScope);
      },
      putYielder: function (a, c, d, e) {
        var f = {};
        f.name = a, f.element = c, f.defaultContent = e || '', f.defaultScope = d, b[a] = f;
      },
      getYielder: function (a) {
        return b[a];
      },
      removeYielder: function (a) {
        delete b[a];
      },
      setContentFor: function (c, d, e) {
        var f = b[c];
        f && (f.element.html(d), a(f.element.contents())(e));
      }
    };
  }
  ...
  function (a) {
    return {
      compile: function (b, c) {
        var d = b.html();
        return null == c.duplicate && b.html(''), function (b, c, e) {
  ...
  function (a, b) {
    return {
      link: function (a, c, d) {
        b.putYielder(d.yieldTo, c, a, c.html()), c.contents().remove(), a.$on('$destroy', function () {
          b.removeYielder(d.yieldTo);
        });
      }
    };
  }
  ...
  '$rootScope',
  function (a) {
    a.carouselPrev = function (b) {
      a.$emit('mobile-angular-ui.carousel.prev', b);
    }, a.carouselNext = function (b) {
      a.$emit('mobile-angular-ui.carousel.next', b);
    };
    var b = function (a) {
        var b = angular.element(document.getElementById(a)), c = angular.element(b.children()[0]).children();
        return b = null, c;
      }, c = function (a) {
        for (var b = -1, c = !1, d = 0; d < a.length; d++)
          if (item = a[d], b += 1, angular.element(item).hasClass('active')) {
            c = !0;
            break;
          }
        return c ? b : -1;
      };
    a.$on('mobile-angular-ui.carousel.prev', function (a, d) {
      var e = b(d), f = c(e), g = e.length - 1;
      -1 !== f && angular.element(e[f]).removeClass('active'), 0 >= f ? angular.element(e[g]).addClass('active') : angular.element(e[f - 1]).addClass('active'), e = null, f = null, g = null;
    }), a.$on('mobile-angular-ui.carousel.next', function (a, d) {
      var e = b(d), f = c(e), g = e.length - 1;
      -1 !== f && angular.element(e[f]).removeClass('active'), f === g ? angular.element(e[0]).addClass('active') : angular.element(e[f + 1]).addClass('active'), e = null, f = null, g = null;
    });
  }
...
}), angular.module('mobile-angular-ui.directives.forms', []).directive('bsFormControl', function () {
  function a(a) {
  ...
  return {
    ...
    link: function (b, c, d) {
      ...
      var e = angular.element('<label for="' + d.id + '" class="control-label">' + d.label + '</label>'), f = angular.element('<div class="form-group row"></div>'), g = angular.element('<div class="form-control-wrapper"></div>'), h = a(d.labelClass.split(/\s+/));
      '' == h.i && e.addClass('col-xs-12'), e.addClass(d.labelClass);
      var i = a(c[0].className.split(/\s+/));
      c.removeClass(i.i), g.addClass(i.i), '' == i.i && g.addClass('col-xs-12'), c.wrap(f).wrap(g), c.parent().parent().prepend(e), c.attr('id', d.id), e = f = g = h = i = null;
    }
  };
  ...
  return {
    ...
    link: function (a, b, c) {
      b.on('click tap', function () {
        null == c.disabled && (a.model = !a.model, a.$apply(), null != a.changeExpr && a.$parent.$eval(a.changeExpr));
      }), b.addClass('switch-transition-enabled');
    }
  };
  ...
  return {
    ...
    restrict: 'C',
    link: function (a, b) {
      b.parent().addClass('has-navbar-top');
    }
  };
  ...
  return {
    ...
    restrict: 'C',
    link: function (a, b) {
      b.parent().addClass('has-navbar-bottom');
    }
  };
    ...
    return {
      compile: function (b) {
        ...
        return function (b, d, e) {
          var f = '', g = c, h = e.overlay;
          if (null != e['default'])
            var f = 'default=\'' + e['default'] + '\'';
          var i = '<div class="overlay" id="' + h + '" toggleable ' + f + ' parent-active-class="overlay-in" active-class="overlay-show">\n  <div class="overlay-inner">\n    <div class="overlay-background"></div>\n    <a href="#' + h + '" toggle="off" class="overlay-dismiss">\n      <i class="fa fa-times-circle-o"></i>\n    </a>\n    <div class="overlay-content">\n      <div class="overlay-body">\n        ' + g + '\n      </div>\n    </div>\n  </div>\n</div>';
          d.remove();
          var j = angular.element(document.getElementById(h));
          j.length > 0 && j.hasClass('overlay') && j.remove(), g = angular.element(document.body), g.prepend(a(i)(b)), 'active' === e['default'] && g.addClass('overlay-in');
        };
      }
    };
  }
  ...
  return {
    ...
    template: function (a, b) {
      var c = '';
      return b.title && (c = '<div class="panel-heading">\n  <h2 class="panel-title">\n    ' + b.title + '\n  </h2>\n</div>'), '<div class="panel">\n  ' + c + '\n  <div class="panel-body">\n     <div ng-transclude></div>\n  </div>\n</div>';
    }
  };
}), angular.module('mobile-angular-ui.pointer-events', []).run([
  '$document',
  function (a) {
    return angular.element(a).on('click tap', function (a) {
      var b;
      return b = angular.element(a.target), b.hasClass('disabled') ? (a.preventDefault(), a.stopPropagation(), b = null, !1) : (b = null, !0);
    });
  }
    ...
    return {
      ...
      restrict: 'C',
      link: function (a, b) {
        return 'native' !== overthrow.support ? (b.addClass('overthrow'), overthrow.forget(), overthrow.set()) : void 0;
      }
    };
  }]), angular.module('mobile-angular-ui.directives.sidebars', []).directive('sidebar', [
  '$document',
  '$rootScope',
  function (a, b) {
    return {
      ...
      link: function (c, d, e) {
        var f = !0;
        ('false' == e.closeOnOuterClicks || '0' == e.closeOnOuterClicks) && (f = !1), d.hasClass('sidebar-left') && d.parent().addClass('has-sidebar-left'), d.hasClass('sidebar-right') && d.parent().addClass('has-sidebar-right');
        var g = function (a, b) {
        ...
        f && (i = b.$on('mobile-angular-ui.toggle.toggled', function (b, c, d) {
          c == e.id && (d ? setTimeout(function () {
            a.on('click tap', h);
          }, 300) : a.unbind('click tap', h));
        })), c.$on('$destroy', function () {
          i(), a.unbind('click tap', h);
        });
      }
    };
  }
]), angular.module('mobile-angular-ui.directives.toggle', []).factory('ToggleHelper', [
  '$rootScope',
  function (a) {
    return {
      events: {
  ...
  function (a, b) {
    return {
      restrict: 'A',
      link: function (c, d, e) {
        var f = e.toggle || b.commands.alternate, g = e.target, h = e.targetClass, i = 'true' === e.bubble || '1' === e.bubble || 1 === e.bubble || '' === e.bubble || 'bubble' === e.bubble;
        if (!g && e.href && (g = e.href.slice(1)), !g && !h)
...
angular.module('users').controller('SettingsController', [
  ...
  function ($scope, $http, $location, Users, Authentication, $timeout, $filter, $stateParams, $rootScope, $state) {
    ...
    if (!$scope.user)
      $location.path('/');
    if ($state.$current.name === 'profile' && !$scope.authentication.isDbAuthorized())
      return $location.path('/settings/accounts');
    Authentication.connectDropstore().then(function (data) {
      $scope.datastore = $scope.authentication.dropstore.datastore;
